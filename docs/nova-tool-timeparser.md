...
→ Warum dieses Prinzip: nova-tool-timeparser_l_evolution.md
...
→ Vollständige Geschichte: nova-tool-timeparser_l_evolution.md
...
→ Lesson: nova-tool-timeparser_l_vektor.md

---

→ Timeline (nutzt Zeitparser): nova-agent-timeline.md
→ Salienz (liefert Zeitausdruck): nova-node-salience.md
→ Lesson Zeitparser-Evolution: nova-tool-timeparser_l_evolution.md
→ Lesson Vektor-Modus: nova-tool-timeparser_l_vektor.md
→ Lesson Timezone: nova-tool-timeparser_l_timezone.md
