...
- **Was das nicht ändert:** die Sachlage-Recherche selbst, `tools/web/search.py`, den Auto-Fetch, die Pixie-Recherche (die im selben Budget der Maschine steht, aber nicht im Turn). **Offen** (Fundliste): Der Thinker formuliert die eine Suche gelegentlich englisch, während die einzige antwortende Engine die deutsche Wikipedia-Volltextsuche ist — in Turn 1 lud er eine Liste von Doppelsternen nach.
