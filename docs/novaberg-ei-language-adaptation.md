# Novaberg — EI: Sprachadaption (CAT)

**Projekt:** Novaberg — The Nova Anima Resonance System
**Dokument:** Modul Sprachadaption (Communication Accommodation Theory)
**Stand:** 17. April 2026, Chat 52 (Code-Alignment)
**Pfad:** novaberg/docs/novaberg-ei-language-adaptation.md
...
→ Enricher (erkennt Stil): novaberg-node-enricher.md
→ Responder (soll Stil nutzen): novaberg-node-responder.md
→ Charakter-Profile (Langzeit-Stil): novaberg-ei-character-profiles.md
→ Perzeption (liefert Stil): novaberg-node-perception.md
