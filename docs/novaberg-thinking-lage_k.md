...
- **Teilung und Parallel-Stränge sind Zielbild, nicht Scheibe 1.** Die erste Scheibe führt **eine** Blase. Erkennt die Analyse zwei unvereinbare Gegenstände, notiert sie das im Artefakt, mehr nicht — die Stapel-Mechanik ist eine eigene, spätere Scheibe.
