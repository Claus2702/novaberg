...
Reflexion ist kein Feature eines einzelnen Nodes — es ist ein **universelles Architekturprinzip**, das in Nova an mehreren Stellen wirkt und an weiteren wirken muss. Das Muster ist immer dasselbe:
