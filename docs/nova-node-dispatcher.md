# Nova — Node: Dispatcher

**Projekt:** Novaberg — The Nova Anima Resonance System
**Dokument:** Node-Referenz Dispatcher
**Stand:** 17. April 2026, Chat 52 (Code-Alignment)
**Pfad:** novaberg/docs/nova-node-dispatcher.md
...
→ Plugin-System: nova-architecture.md
→ PendingWrite-Format: nova-graph.md — Graph-Architektur`, Abschnitt 4
→ Salienz (Entscheider): nova-node-salience.md
→ KZG-Agent: nova-mem-kzg.md / nova-pixie-kzg.md
→ DelegationsAgent: nova-pixie-delegation.md (Yin-Yang-Prinzip / VENT1 — Lesson-Kontext in nova-ei-character-profiles_l.md)
