# Nova — Gedächtnis: Langzeitgedächtnis (LZG)

**Projekt:** Novaberg — The Nova Anima Resonance System
**Dokument:** Modul Langzeitgedächtnis
**Stand:** 17. April 2026, Chat 52 (Code-Alignment)
**Pfad:** novaberg/docs/nova-mem-lzg.md
...
→ Vollständige Details: nova-pixie-decay.md — Ebbinghaus-Decay`
...
→ Gedächtnis-Konzept: nova-memory.md, Abschnitt 2.4
→ KZG (Eingangsstufe): nova-mem-kzg.md / nova-pixie-kzg.md
→ Ebbinghaus-Decay (Details): nova-pixie-decay.md
→ Zwei-Call-Promotion: nova-pixie-promotion.md
→ Charakter-Profile: nova-ei-character-profiles.md
→ Pixie-Tasks: nova-pixie.md
