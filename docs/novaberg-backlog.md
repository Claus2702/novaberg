...
| **SYK-B4-GRENZE-ZAHLWORT** | Stufe 1 liest nur Ziffern. Ausgeschriebene Zahlen („dreiunddreißig") werden nicht erkannt — die Fallenbatterie enthält mindestens einen solchen Fall. Als Filter ist die Richtung harmlos (zählt eher zu wenig), als Grundlage einer Rate nicht | B4 |
