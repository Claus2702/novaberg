...
**Archiv:** [`novaberg-bugs-archiv.md`](novaberg-bugs-archiv.md) — **52 abgeschlossene Eintraege mit eigenem Abschnitt**, `[gemessen]` 30.08.2026. Ein behobener Defekt bleibt mit Vermerk stehen; er steht nur nicht mehr hier.
**Offen hier:** **48 Eintraege mit eigenem Abschnitt**, dieselbe Zaehlung. Davon tragen 91 eine `Zustand:`-Zeile mit *offen* und 20 eine mit *unbelegt — braucht Messturn*; **kein Eintrag ist abgeschlossen und wartet auf den Umzug**. Die frueheren Kopfzahlen (131/123) waren fortgeschrieben und widersprachen einander — die Eintragsform ist uneinheitlich, siehe Fundliste 30.08.2026.
