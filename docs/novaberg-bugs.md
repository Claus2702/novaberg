...
**Zustand:** offen — gemessen am 09.09.2026 an 200 Turns und am Bestand, gegen HEAD `cb7e899`. **Baubereit:** Abhilfe, Vorher-Rechnung und Pruefform stehen; offen ist **eine** Absichtsfrage (unten).
...
**Geschlossen, wenn** `gravitationsterm` an beiden Lesern in [0, 1] liegt, ohne Kappung, und `gekappt` wieder die Ausnahme ist statt des Normalfalls.
