...
*Aktualisiert in Chat 57. SEARX1 als transient bestätigt (Code prüft `len(results)`, nicht `number_of_results`) und in Behobene-Tabelle verschoben. Stand-Header auf Chat 57 gezogen.*
