...
### `INDEXLAUF-VERSCHWEIGT-DATEIFEHLER` — offen
...
**Geschlossen, wenn** die Bilanz je Wurzel eine Zahl `gescheitert` samt Pfaden und Grund trägt — nach dem Vorbild von `uebergangen_gruende` — und ein Zeuge die Identität `neu == indiziert + offen + gescheitert` prüft.
