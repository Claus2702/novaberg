...
**Zustand:** offen — gemessen am 25.08.2026 gegen den Produktivbestand. **Die Absicht ist am 25.08.2026 entschieden** (`novaberg-pixie-character-hash.md` §3.1a: die **Grundlage** wird fortgeschrieben, nicht der Text). → **Am 26.08.2026 steht auch das Auswahlkriterium, und der Riegel ist aufgehoben** (`KERNAUSWAHL-KRITERIUM-OFFEN`, geschlossen): **festes Zeichenbudget beim Vierfachen des heutigen, darin zeitlich geschichtet.** **Damit ist der Eintrag baubereit** — Quelle `_turns_laden`, Verteilungsregel und Budget stehen, und die Abnahme ist die Rechnung dieses Eintrags gegen dieselbe Kontrolle.
