...
#### ZEIT-RUECKWAERTS-WIRD-ZUKUNFT — ein rückwärts gerichteter Zeitausdruck erzeugt einen Anker in der Zukunft 🔧 Teil (b) gelöst Chat 119
...
**Offen bleibt (a):** Die Extraktion verwirft das Richtungswort, bevor der Parser es sieht. Das ist eine Prompt-Frage und in diesem Eintrag unverändert beschrieben. Solange sie offen ist, kommt beim Parser weiterhin eine nackte Dauer an — die dann korrekt nach vorn aufgelöst wird, weil ihr die Richtung fehlt.
