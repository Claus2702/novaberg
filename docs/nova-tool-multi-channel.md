# Nova — Tool: Multi-Channel-Architektur
...
Nova ist nicht an einen einzelnen Client gebunden. Der Server (FastAPI) ist kanal-agnostisch — er weiß nicht, ob die Nachricht vom Desktop-Client, vom Telegram-Bot oder einem zukünftigen Web-Interface kommt.
