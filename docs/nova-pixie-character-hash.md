# Nova — Pixie-Agent: CharakterAgent (Hash-Destillation)

**Projekt:** Novaberg — The Nova Anima Resonance System
**Dokument:** CharakterAgent — Charakter-Hash aus KZG/LZG destillieren
**Stand:** 17. April 2026, Chat 52 (Code-Alignment)
**Pfad:** novaberg/docs/nova-pixie-character-hash.md
...
Verwandte Dokumente:
- DecayAgent (Ebbinghaus-Gewichtung): `nova-pixie-decay.md`
- PromotionAgent (hash_dirty-Setter): `nova-pixie-promotion.md`
- KZG-Agent (Datenquelle Adaptiv): `nova-pixie-kzg.md`
