...
→ Emotionale Intelligenz (bestehend): nova-ei.md
→ Perzeption (Eingangs-Analyse): nova-node-perception.md
→ Emotions-Vektoren (Richtung der Stimmung): nova-node-perception.md
→ Intentions-Schicht: nova-node-salience.md
→ Pixie-Konzept: nova-pixie.md
→ Kognitive Anreicherung (Epic 8): nova-backlog.md
