...
| `[ANGEBOT]` | ✅ | — **seit 18.09.2026 (Scheibe 12 E2).** Steht eine akute Sache am Zettel von Timeline oder Notizen, hat niemand darum gebeten und reicht Novas Pflichtbewusstsein zum Menschen (`ANGEBOT_PFLICHT_SCHWELLE` 0,9), bietet Person A am Ende an, sie einzutragen oder zu notieren (`prompts/default/verfasser.angebot.txt`). Nicht auf einem Impuls, nicht für eine abgelehnte Sache (E3). Jeder Ausgang als `verfasser.angebot` im Pipeline-Log. |
| `[IDENTITAET]` | — | ✅ |
| `[EIGENE_EMOTION]` | — | ✅ |
| `[KOMMUNIKATION]` | — | ✅ |
| `[REGELN]` | — | ✅ |
