# Novaberg — Antrieb (Umsetzung)

**Teil 2 von 3 — Umsetzung und Ausarbeitung.** Absicht und Planung: [`novaberg-thinking-drive_k.md`](novaberg-thinking-drive_k.md) · Entscheidungen und offene Fragen: [`novaberg-thinking-drive_e.md`](novaberg-thinking-drive_e.md). Die Abschnittsnummern sind die des ungeteilten Konzepts.

---

## Bisheriger Kopf

Der Stands-Kopf des ungeteilten Konzepts, ungekürzt.
...
> **Hinweis zur Aufteilung (19.09.2026):** Die Absicht — ein zielrelevanter Turn wird bevorzugt gespeichert — steht im letzten Absatz und in `_k` §5.1; der Abschnitt steht wegen Rechnung und Berichtigung hier. §8.2 in `_k` nennt noch die ersetzte Addition (Befund B1 in `_e`).
...
→ Absicht und Planung: [`novaberg-thinking-drive_k.md`](novaberg-thinking-drive_k.md)
→ Entscheidungen, offene Fragen, Befunde: [`novaberg-thinking-drive_e.md`](novaberg-thinking-drive_e.md)
