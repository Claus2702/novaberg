...
**Pfad:** novaberg/docs/nova-node-tribunal.md
...
> **Warum die Kalibrierung?** Ohne sie warnte der Jurist bei jeder Terminerwähnung wegen „Datenschutz", obwohl die Daten vom Nutzer selbst stammten. → nova-graph_l.md
...
→ Corrector (bei Ablehnung): nova-node-corrector.md
→ Kontaminations-Lesson: nova-graph_l.md
→ Graph-Konzept (Tribunal-Philosophie): nova-graph.md, Abschnitt 3
