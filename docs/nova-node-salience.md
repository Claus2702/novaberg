...
**Pfad:** novaberg/docs/nova-node-salience.md
...
> **Lesson gelernt (Chat 3):** Ohne Trennung mittelte die Salienz über den gesamten Turn. „Ich bin total überfordert!" (kurz, emotional) + Novas Antwort (200 Wörter, sachlich) = Salienz 0.40 statt 0.70. Die Trennung + die explizite Anweisung „bewerte nur die Eingabe des Nutzers" löste das Problem. → `nova-node-salience_l.md`
...
→ Historie: `nova-node-dispatcher_l.md — Lesson: Doppelspeicherung`
...
→ KZG-Agent (verdichtet + speichert): nova-mem-kzg.md / nova-pixie-kzg.md
→ LZG (Promotion-Ziel): nova-mem-lzg.md
→ Pixie (Shadow-Queue): `nova-pixie.md`
→ Architektur: `nova-architecture.md §4`
→ Gedächtnis-Konzept: `nova-memory.md`
→ Graph-Übersicht: `nova-graph.md`
→ Lesson Salienz-Mittlung: `nova-node-salience_l.md`
→ Lesson Doppelspeicherung: nova-node-dispatcher_l.md
→ Lesson Kontamination: `nova-graph_l_kontextualisierung.md`
→ Ebbinghaus-Decay: `nova-pattern-ebbinghaus-decay.md`
