# Novaberg — Pattern: Entity Resolution

**Projekt:** Novaberg — The Nova Anima Resonance System
**Dokument:** Technik Entity Resolution (Entitäten auflösen und disambiguieren)
**Stand:** 17. April 2026, Chat 52 (Code-Alignment)
**Pfad:** novaberg/docs/novaberg-pattern-entity-resolution.md
...
→ Knowledge Graph Konzept: novaberg-mem-knowledge-graph.md
→ Zwei-Call-Promotion: novaberg-pixie-promotion.md
→ Fakten-Pipeline: novaberg-mem-knowledge-graph.md
