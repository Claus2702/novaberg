...
Die Information Gap Theory (beschrieben in `nova-thinking-curiosity_k.md`) erklärt, wann Neugier entsteht: bei einer Lücke in vorhandenem Wissen. Der Antrieb erklärt, **warum** bestimmte Lücken interessieren und andere nicht. Neugier sagt "Ha, das will ich wissen!" — ein Ziel sagt "Ich verfolge das aktiv." Neugier ist der Moment, Antrieb ist die Richtung.
...
10. Loewenstein, G. (1994). The Psychology of Curiosity. *Psychological Bulletin*, 116(1). (Information Gap Theory — `nova-thinking-curiosity_k.md`)
11. Friston, K. (2010). The Free Energy Principle. *Nature Reviews Neuroscience*, 11(2). (Predictive Processing — `nova-node-gv_k.md`)
12. Clark, A. (2015). *Surfing Uncertainty*. Oxford UP. (Predictive Brain — `nova-node-gv_k.md`)
13. Schmidhuber, J. (1991). Curious Model-Building Control Systems. (Compression Progress — `nova-thinking-curiosity_k.md`)
...
- Kein Ersatz für die Neugier (`nova-thinking-curiosity_k.md`) — Antrieb ist Richtung, Neugier ist Moment

### 13.3 Zusammenspiel der Konzeptdokumente

| Dokument | Frage | Zusammenspiel |
|----------|-------|---------------|
| `nova-thinking-curiosity_k.md` | Wann sagt Nova "Ha!"? | Neugier feuert, wenn ein gravitativ angezogenes Thema eine Wissenslücke offenbart |
| `nova-thinking-drive.md` | Warum interessiert es Nova? | Ziele bestimmen, welche Themen gravitativ angezogen werden |
| `nova-node-gv_k.md` | Wohin geht das Gespräch? | Der GV-Node nutzt aktivierte Zielsätze als Kontext für die Hypothese |
| `nova-node-salience.md` | Was merkt sich Nova? | Der Gravitationsterm boosted die Salienz zielrelevanter Themen |
| `nova-pixie-delegation.md` | Was löst Hintergrundarbeit aus? | Die erhöhte Salienz triggert den DelegationsAgent häufiger bei zielrelevanten Themen |
| `nova-ei.md` | Was fühlt Nova? | Die Dual-Emotion-Architektur gibt Nova einen eigenen Emotionsstrom neben dem Nutzer-Strom |

---

→ Neugier-Mechanismus (Resonanz, Traum-Modus): `nova-thinking-curiosity_k.md`
→ Gesprächsvektor (Trajektorie, GV-Node): `nova-node-gv_k.md`
→ Salienz (Bewertung, KZG-Steuerung): `nova-node-salience.md`
→ Emotionale Intelligenz (Plutchik, Vektoren): `nova-ei.md`
→ Pixie-Delegation (Shadow-Queue, Trigger): `nova-pixie-delegation.md`
→ Charakter-Destillation (Hash, 6 Schichten): `nova-ei-character-profiles.md`
