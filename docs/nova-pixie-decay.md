# Nova — Pixie-Agent: DecayAgent

**Projekt:** Novaberg — The Nova Anima Resonance System
**Dokument:** DecayAgent — Ebbinghaus-Vergessenskurve
**Stand:** 17. April 2026, Chat 52 (Code-Alignment)
**Pfad:** novaberg/docs/nova-pixie-decay.md
...
Verwandte Dokumente:
- PromotionAgent (Verstärkungs-Quelle): `nova-pixie-promotion.md`
- CharakterAgent (nutzt gewichtete Einträge): `nova-pixie-character-hash.md`
- KZG-Agent (KZG-Verstärkung): `nova-pixie-kzg.md`
