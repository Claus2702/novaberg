...
│   │   ├── synapsen_decay/              #   Der Tageslauf (Pixie), vier Schritte: Knoten-Decay · pipeline_log-Retention · Queue-Verfall · Faltung der Prägungsfäden
...
| `praegung_faden` | im Betrieb belegt 01.09.2026 — 4 Zeilen | novaberg-node-praegung.md |
| `praegung_beruehrung` | Schema angelegt, leer — die erste Beruehrung steht aus | novaberg-node-praegung.md §7 |
