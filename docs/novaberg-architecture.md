...
│   │   ├── synapsen_decay/              #   Der Tageslauf (Pixie), zehn Schritte: Knoten-Decay · pipeline_log-Retention · Queue-Verfall · Faltung der Prägungsfäden · Nachzug der Stränge · Strang-Richtungen · Einfärbungen · Qualitätsprofile · Trägerseite der Faszination · Preiswächter (→ novaberg-memory-qualitaetsprofil.md, novaberg-thinking-faszination_k.md §10.6)
