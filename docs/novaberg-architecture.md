...
| `OPENROUTER_PROVIDER` | `"baidu"` | **Welcher Anbieter die ID bedienen darf.** Hinter ihr standen am 05.09.2026 **29**; ohne diese Zeile wählt der Zugang pro Aufruf, und Preis, Quantisierung und Kontextfenster sind nicht die konfigurierten |
