...
`tools/openrouter_price_watch.py` hält Preis, Rabatt, Fenster, Quantisierung
...
│   │   ├── synapsen_decay/              #   Der Tageslauf (Pixie), neun Schritte: Knoten-Decay · pipeline_log-Retention · Queue-Verfall · Faltung der Prägungsfäden · Nachzug der Stränge · Strang-Richtungen · Einfärbungen · Qualitätsprofile · Trägerseite der Faszination (→ novaberg-memory-qualitaetsprofil.md, novaberg-thinking-faszination_k.md §10.6)
