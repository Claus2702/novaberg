...
│   │       ├── praegung.py              #     → novaberg-node-praegung.md (Faden-Tor, Praegungszug)
...
│   │   ├── synapsen_decay/              #   Der Tageslauf (Pixie), acht Schritte: Knoten-Decay · pipeline_log-Retention · Queue-Verfall · Faltung der Prägungsfäden · Nachzug der Stränge · Strang-Richtungen · Einfärbungen · Qualitätsprofile (→ novaberg-memory-qualitaetsprofil.md)
...
│   │   ├── fascination.py               #   Der Merkmalszug: sechs Qualitäten → eine Zahl, weiches ODER (→ novaberg-memory-qualitaetsprofil.md §5)
