...
| 2 | S14a Sachlage — Wiederaufnahme, Verstehen, Verlauf, kurzfristiges Ziel, Brücke | `graph/nodes/sachlage.py`, `memory/sachlage_history.py`, `memory/kurzziel.py` | unrein (Modell, Redis, PostgreSQL) |
