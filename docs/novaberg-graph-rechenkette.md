...
| 2 | S14a Sachlage — Wiederaufnahme, Verstehen, Verlauf, kurzfristiges Ziel, Brücke, Frame-Auflöser (Scheibe 6, 28.08.2026), Plausibilität (Scheibe 7, 29.08.2026) | `graph/nodes/sachlage.py`, `graph/nodes/sachlage_resolver.py`, `graph/nodes/sachlage_plausibility.py`, `memory/sachlage_history.py`, `memory/kurzziel.py` | unrein (Modell, Redis, PostgreSQL) |
...
**Prüfstand:** `test_sachlage.py`, `test_sachlage_bruecke.py`, `test_sachlage_verlauf_schema.py` (live), `test_sachlage_kette.py`, `test_kurzziel.py`, `test_sachlage_resolver.py` (Scheibe 6), `test_sachlage_plausibility.py` (Scheibe 7).
