# Novaberg — Der Dateien-Dienst: ein Verzeichnis, das gelesen werden darf (Ausarbeitung)

**Teil 2 von 5 — Ausarbeitung.** Absicht und Kopfblock: [`novaberg-agent-dateien_k.md`](novaberg-agent-dateien_k.md) · Bauplan und Umstellung: [`novaberg-agent-dateien_b.md`](novaberg-agent-dateien_b.md) · Diskussion und Ergänzungen: [`novaberg-agent-dateien_e.md`](novaberg-agent-dateien_e.md) · Messungen: [`novaberg-agent-dateien_m.md`](novaberg-agent-dateien_m.md). Die Abschnittsnummern sind die des ungeteilten Konzepts; welche Datei einen Abschnitt trägt, sagt die Tabelle *„§ → Datei“* in `_k`.

---

## Aus §1a — Was in den Dateien steht, ist nicht sie

§1a, §1a.1, §1a.3 und §1a.4 stehen in [`novaberg-agent-dateien_k.md`](novaberg-agent-dateien_k.md).
...
> **Hinweis zur Teilung.** Der Kasten *„Gemessen im Betrieb, 22.08.2026“* steht in [`novaberg-agent-dateien_m.md`](novaberg-agent-dateien_m.md), *Aus §1a.5*.
...
> **Hinweis zur Teilung.** Der Kasten zum Zustand am Tag des Baus — die dritte Wurzel, der Außenrand, der ursprüngliche Zustand — steht in [`novaberg-agent-dateien_b.md`](novaberg-agent-dateien_b.md), *Aus §1a.5*.

---

§2, §2.1 und §2.2 stehen in [`novaberg-agent-dateien_k.md`](novaberg-agent-dateien_k.md).
...
## Aus §3 — Zwei Zugänge, drei Dienste

§3 und §3.0 stehen in [`novaberg-agent-dateien_k.md`](novaberg-agent-dateien_k.md).

### 3.0a Die Schwelle wird gemessen, nicht gesetzt — und 0,40 war keine Messung

> **Hinweis zur Teilung.** Einleitung und die Unterabschnitte *Der Präzedenzwert hat der Prüfung nicht standgehalten* und *Der Median sagt etwas über den Korpus, nicht über das Embedding* sind Messungen und stehen in [`novaberg-agent-dateien_m.md`](novaberg-agent-dateien_m.md), *§3.0a*. Hier steht der Unterabschnitt, der daraus die Folgerung für den Index zieht.
...
> **Hinweis zur Teilung.** §3a.1 (*Was gebaut ist und was fehlt*) steht in [`novaberg-agent-dateien_b.md`](novaberg-agent-dateien_b.md).
...
> **Hinweis zur Teilung.** Der Kasten *„Gebaut am 18.08.2026, und der Weg steht“* steht in [`novaberg-agent-dateien_b.md`](novaberg-agent-dateien_b.md), *Aus §4b*.
...
> **Hinweis zur Teilung.** Der Absatz *„Gemessen am 23.08.2026 gegen den echten Bestand …“* steht in [`novaberg-agent-dateien_m.md`](novaberg-agent-dateien_m.md), *Aus §5.6*.
...
3. **Eine Wurzel entsteht aus einer Festlegung, und die Festlegung hat drei Riegel.** Dass ein Mensch das Verzeichnis im Gespräch nennt, ist gewollt (§2a) — und damit bestimmt eine Äußerung einen Pfad im Dateisystem. Das ist genau die Stelle, an der ein Dienst mit Dateizugriff gefährlich wird, und sie braucht mehr als ein Tor:
   ...
   **a) Ein konfigurierter Außenrand.** Es gibt eine Menge zulässiger Elternverzeichnisse, und sie steht in der Konfiguration. Innerhalb davon darf der Mensch freigeben, außerhalb nicht — auch nicht mit Bestätigung. Ohne diesen Rand könnte ein Gespräch das Wurzelverzeichnis freigeben.
   ...
   > **Hinweis zur Teilung.** Der Kasten *„Gebaut am 18.08.2026: `DATEIEN_AUSSENRAND` …“* mit den Nachträgen vom 20.08.2026 steht in [`novaberg-agent-dateien_b.md`](novaberg-agent-dateien_b.md), *Aus §7*.
...
> **Hinweis zur Teilung.** §8.1a (*Warum dieser Dienst nicht optional ist — gemessen, nicht argumentiert*) steht in [`novaberg-agent-dateien_m.md`](novaberg-agent-dateien_m.md).
...
§9 steht in [`novaberg-agent-dateien_e.md`](novaberg-agent-dateien_e.md), Abschnitt D; §10 in [`novaberg-agent-dateien_k.md`](novaberg-agent-dateien_k.md).
