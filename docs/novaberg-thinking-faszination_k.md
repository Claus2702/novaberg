...
|---|---|---|---|
| 0 | Wie dieses Dokument entstanden ist | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 1 | Warum die Größe fehlt | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 1.1 | Der Beleg, dass die Schicht fehlt | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 2 | Wissenschaftliche Verankerung | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 2.1 | Mühelose Aufmerksamkeitsbindung | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 2.2 | Reizseite und Personenseite | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 2.3 | Self-Defining Memory | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 2.4 | Intensität und Valenz | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 2.5 | Fading-Affect-Bias | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 2.6 | Die weiteren Nachbarn | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 2.7 | Kriegsgeschichte und Gartenkräuter | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 2.8 | Was die Literatur nicht liefert | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 2.9 | Was dieses Konzept beansprucht | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 3 | Die drei Faktoren im Überblick | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 4 | Der Träger ist ein Merkmalsprofil | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 4.1 | Der Zwilling-Test | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 4.2 | Drei Ebenen | [`_k`](novaberg-thinking-faszination_k.md) |  |
...
| 7.13 | Zwei Grenzen | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 8 | Die Prägung ist die emotionale Erinnerung | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 8.1 | Ziele bekommen einen emotionalen Geschmack | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 8.2 | LZG-Erinnerungen | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 8.3 | EI-Calc | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 8.4 | Warum der Sektorfaktor hier sitzt | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 8.5 | Der Strang trägt die Meinung | [`_k`](novaberg-thinking-faszination_k.md) | trägt eine Setzung des Eigentümers; Verweis in `_e` |
| 9 | Drei Schienen | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 9.1 | Das Aufnahmekriterium | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 9.2 | Charakter-Hash und Stränge | [`_k`](novaberg-thinking-faszination_k.md) | Absicht mit Berichtigungen am Beleg |
| 9.3 | Wo Konsistenz zu prüfen wäre | [`_k`](novaberg-thinking-faszination_k.md) |  |
| 10 | Die Rechnung (Überschrift) | [`_t`](novaberg-thinking-faszination_t.md) |  |
...
**[Widerlegt am 05.09.2026 — gemessen gegen die Eröffnungsformel als Stellvertreter der
Formklassifikation.]** Die Formel ist im Verdichtungs-Prompt vorgeschrieben und trennt: Die
Frageform liegt bei **0 von 115** Knoten über 400 Zeichen, die Erklärform bei 4,3 % von 417 — die
Einsichtsform bei **56,7 % von 409**. **Von den 409 Einsichten fallen 177 durch den Zeichenschnitt**,
also 43 % der Klasse, die der Filter treffen soll. Die Themen als Ersatz tragen es nicht: Sie
entstehen im Salienz-Knoten aus dem *Turn*, nicht aus dem gespeicherten Satz.

> **Und die Messung stellt den Filter selbst in Frage, nicht nur seine Bauart.** Die Skala kann
> Null sagen (§6.2); im Bestand steht trotzdem **keine gemessene Null** — 49 von 50 Trägern
> schlagen voll aus, der kürzeste misst 410 Zeichen. Ein ausgefilterter Knoten ist kein Träger mit
> Faszination 0, sondern gar kein Träger. Die Belege und die drei offenen Wege stehen in
> `novaberg-memory-qualitaetsprofil.md` §4a/§4b; entschieden ist keiner.
...
*Aufteilung: Die Unterabschnitte „Die Tabellen“ und „Die Formkurve“ stehen in [`_t`](novaberg-thinking-faszination_t.md) §7.2.*
...
*Aufteilung: Absicht mit einem nachgetragenen Betriebsbeleg — bleibt hier.*
...
### 7.4 → [`_t`](novaberg-thinking-faszination_t.md) §7.4 — Verstärkung füllt die Lücke, sie setzt nicht zurück
...
### 7.7 → [`_t`](novaberg-thinking-faszination_t.md) §7.7 — Der Strang · 7.8 Die Sektor-Destillation · 7.9 Verfall
...
*Aufteilung: Absicht mit einer Messung, die sie relativiert — bleibt hier.*
...
### 8.5 Der Strang trägt die Meinung — Setzung des Eigentümers, 05.09.2026

*Aufteilung: Der Abschnitt trägt eine Setzung des Eigentümers und bleibt deshalb hier; [`_e`](novaberg-thinking-faszination_e.md) verweist darauf.*

**Die dritte Leistung der Schicht, und sie ist die erste, die außerhalb dieses Dokuments gebraucht
wird.**
...
**Die Stufung ist keine Rangfolge, sondern eine Bauabhängigkeit — und sie läuft anders herum als
gedacht.** Die Faszination ist ein Produkt aus neun Faktoren und **valenzblind** (§2.4): Sie sagt,
wie stark etwas bindet, nicht in welche Richtung. Die Richtung sitzt eine Ebene tiefer, in der
`valenz` des Strangs — und die ist gebaut, im Bestand und über neun Stränge belegt.

> **Wer die emotionale Einstellung bauen will, braucht nicht auf die Faszination zu warten.** Die
> Größe, die eine Meinung tragen kann, existiert bereits; die Größe, die auf ihr aufsetzt, hat
> keinen Leser und niedrige Werte.

**Der Vorbehalt ist derselbe wie in §7.9 und er begrenzt die Aussage:** Alle neun Stränge tragen
heute eine **positive** Valenz. Die Skala ist vorzeichenbehaftet und trennt fein (`begeisterung`
1,00 gegen `freude` 0,80) — der Bestand nutzt ihre negative Hälfte nur nicht. Nova könnte damit
*gut* sagen und nicht *schlecht*, und das ist ein Zustand des Bestandes, kein Fehler der Rechnung.

**Die Gegenseite gehört ausdrücklich nicht hierher.** Die fachliche Beurteilung ist ein Vorgang und
kein Speicher: Sie holt Informationen über die Sache, während der Strang etwas über Nova sagt. Wer
ein Rechercheergebnis in einen Strang schriebe, machte aus einer Auskunft eine Charaktereigenschaft.
Beides führt `novaberg-thinking-opinion_k.md` §2a als (A) und (B).
...
*Aufteilung: Absicht mit Berichtigungen am Beleg — bleibt hier.*
...
## 10. Die Rechnung — die Bauregeln hier, die Rechnung (§10.1–10.6a) in [`_t`](novaberg-thinking-faszination_t.md)
...
### 10.1–10.6a → [`_t`](novaberg-thinking-faszination_t.md) — Merkmalszug, Anker, Prägungszug, Strangzug, Verfall, Modulatoren, Zusammenführung, Bezeichner, Konstanten
...
|---|---|---|
| **Sie fragt mehr** | `fragen` im Haltungsraum | **gebaut am 07.09.2026** — der Leser steht |
| ~~**Sie schreibt länger — aber nur hier**~~ | ~~`umfang`, nach Träger aufgeschlüsselt~~ | **gegenstandslos** — siehe den Kasten unten |
...
> **Stand 05.09.2026: keine der vier ist gefahren.** §12.1 ist als Zeuge auf Modulator-Ebene
> vorhanden (`tests/test_faszination_modulatoren.py`) — die Probe über den **ganzen** Faktorsatz ist
> es nicht; §12.2 bis §12.4 gar nicht. **Sie sind damit der billigste offene Posten der Schicht:**
> Sie kosten keinen Bestand, keine Laufzeit und keinen Modellaufruf, und sie sind das einzige
> Verfahren, das prüft, ob die Größe tut, wofür sie entworfen wurde.
...
## 15. → [`_e`](novaberg-thinking-faszination_e.md) §15 — Entscheidungsprotokoll

## 16. → [`_t`](novaberg-thinking-faszination_t.md) §16 — Verworfene Ansätze mit Grund
