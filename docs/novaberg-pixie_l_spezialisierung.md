...
**Pfad:** novaberg/docs/novaberg-pixie_l_spezialisierung.md
...
Gleichzeitig zeigte die OpenClaw-Analyse: das dortige System nutzt Claude Sonnet für alles — ein leistungsstarkes Generalisten-Modell, das auf API-Kosten läuft. Diesen Luxus hat Novaberg nicht.
...
OpenClaw braucht ein Modell, das alles kann — Reasoning, Sprache, Toolnutzung, Kreativität. Novaberg kann die Aufgaben auf spezialisierte Modelle verteilen:
